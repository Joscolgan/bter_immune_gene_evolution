...
with open('CNV_duplications_shuffle.txt') as duplications:
...
ALIGNED_DATA            = "results/{samples}.sorted"

# Assign path for BED files containing CNV information.
DUPLICATED_DATA         = "shuffle_analysis/{duplications}.bed"

# Output intersected BAM files here.
INTERSECTED_DATA        = "shuf_median_temp/01_intersect_bam/{duplications}.{samples}.bam"

# Output depth counts here.
DEPTH_DATA              = "shuf_median_temp/02_depth_bam/{duplications}.{samples}.depth.txt"

# Output mean counts per sample here.
#CALCULATED_MEDIAN_DATA  = "shuf_median_temp/03_median_counts/{duplications}.{samples}.median_depth.txt"

# Output combined mean data here.
#COMBINED_MEDIAN_DATA    = "shuf_median_temp/04_combined_counts/{duplications}.combined.median_depth.txt"

# Output combined CNV mean data here.
#COMBINED_CNV_DATA       = "shuf_median_temp/05_combined_CNV_means/combined.median_depth.all_CNVs.txt"

# Output final data file here.
#FINAL_DATA              = "shuf_median_temp/06_final/final_combined.median_depth.all_dups.txt"
...
rule all:
    input: expand(DEPTH_DATA,samples=SAMPLES, duplications=DUPLICATIONS)
